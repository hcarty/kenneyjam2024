...
ifeq ($(config),debuguniv64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/kenneyjam2024d
  DEFINES   += -D__orxDEBUG__
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/imgui -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -arch x86_64 -arch arm64 -stdlib=libc++ -std=c++11 -gdwarf-2 -Wno-unused-function -Wno-write-strings
...
ifeq ($(config),profileuniv64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/kenneyjam2024p
  DEFINES   += -D__orxPROFILER__
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/imgui -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -O2 -arch x86_64 -arch arm64 -stdlib=libc++ -std=c++11 -gdwarf-2 -Wno-unused-function -Wno-write-strings
...
ifeq ($(config),releaseuniv64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/kenneyjam2024
  DEFINES   +=
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/imgui -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -O2 -arch x86_64 -arch arm64 -stdlib=libc++ -std=c++11 -gdwarf-2 -Wno-unused-function -Wno-write-strings
...
ifeq ($(config),debug64)
  ...
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/imgui -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -m64 -stdlib=libc++ -std=c++11 -gdwarf-2 -Wno-unused-function -Wno-write-strings
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
...
ifeq ($(config),profile64)
  ...
  INCLUDES  += -I$(ORX)/include -I../../../include/Scroll -I../../../include/imgui -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -O2 -m64 -stdlib=libc++ -std=c++11 -gdwarf-2 -Wno-unused-function -Wno-write-strings
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-exceptions -fno-rtti
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L$(ORX)/lib/dynamic -L. -m64 -L/usr/lib64 -stdlib=libc++ -dead_strip
  LIBS      += -lorxp -framework Foundation -framework AppKit
...
$(OBJDIR)/kenneyjam2024.o: ../../../src/kenneyjam2024.cpp
	@echo $(notdir $<)
